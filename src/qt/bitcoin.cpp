...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "defcoin",
    ...
    QApplication::setOrganizationName("defcoin");
    QApplication::setOrganizationDomain("defcoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("defcoin-Qt-testnet");
    else
        QApplication::setApplicationName("defcoin-Qt");
