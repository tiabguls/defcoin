...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "defcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed.defcoin.org", "seed.defcoin.org"},
    {"seed2.defcoin.org", "seed2.defcoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"test.defcoin.org", "test.defcoin.org"},
    {"test2.defcoin.org", "test2.defcoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. defcoin is probably already running."), addrBind.ToString().c_str());
        else
